...
%            end 
            ...
            Simbolpos3=total_envelope(start+2*newover:start+3*newover);
            V3= var(Simbolpos3)
            M3=mean(Simbolpos3)
            
            Simbolmin3=total_envelope(start+3*newover+1:start+4*newover);
            V0= var(Simbolmin3)
            M0=mean(Simbolmin3)
            
            Simbolmin1=total_envelope(start+4*newover+1:start+5*newover);
            V1= var(Simbolmin1);
            M1=mean(Simbolmin1);
            
            Simbolpos1=total_envelope(start+5*newover+1:start+6*newover);
            V2= var(Simbolpos1);
            M2=mean(Simbolpos1);
           ...
           Tress23
            ...
            % alphabet: -3; -1; 1; 3
            ipHat(find(x< Tress01)) = -3;
            ipHat(find(x>= Tress23)) = 3;
            ipHat(find(x>=Tress01 & x<Tress12)) = -1;
            ipHat(find(x>=Tress12 & x<Tress23)) = 1;
